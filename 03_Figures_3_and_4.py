...
# ----------------------------------------------------
# kappa x Acceptance rates by dimension d
# ----------------------------------------------------
...
theme(plot_title = element_text(size = 25, hjust = 0.5),
    ...
    panel_grid_minor = element_blank()) +
# + 
# facet_grid('N ~ method', scales='free_y'))
...
# ----------------------------------------------------
# Plot the difference in the acceptance rates
# ----------------------------------------------------
test['diff_acc_rate'] = test['acc_rate'] / (2*norm.cdf(-test['kappa']/2))

plot = (ggplot(test) +
# aes(x='kappa', y='meanSJD', colour='method') +  
aes(x='kappa', y='diff_acc_rate', colour='method') +  
 geom_point(size=2) +
 geom_line(size=1) +
...
plot.save('optimal_diff_acc_rate_d_lambda.pdf', height=height_plot, width=width_plot)
...
# ----------------------------------------------------
# MSJD/E(B) x acceptance rate by dimension d
# ----------------------------------------------------
test['method'] = test.method.astype(str)

plot = (ggplot(test[test['method'] == 'SMH-1']) +
aes(x='acc_rate', y='MSJD_over_B', colour='method') +  
    geom_line(linetype = "dashed", size=2) +
    geom_point(aes(shape = 'method'), size=6) +
    # geom_segment(aes(x = 1.5, xend = 1.5, y = 0, yend = 4e-7), colour='#1F78B4', size=0.4, linetype='dotted') +
...
plot = (ggplot(test[test['method'] == 'SMH-1-NB']) +
aes(x='acc_rate', y='MSJD_over_B', colour='method') +  
    geom_line(linetype = "dashed", size=2) +
    geom_point(aes(shape = 'method'), size=6) +
    # geom_segment(aes(x = 1.5, xend = 1.5, y = 0, yend = 4e-7), colour='#1F78B4', size=0.4, linetype='dotted') +
...
plot = (ggplot(test[test['method'] == 'SMH-2']) +
aes(x='acc_rate', y='MSJD_over_B', colour='method') +  
    geom_line(linetype = "dashed", size=2) +
    geom_point(aes(shape = 'method'), size=6) +
    # geom_segment(aes(x = 1.5, xend = 1.5, y = 0, yend = 4e-7), colour='#1F78B4', size=0.4, linetype='dotted') +
...
plot = (ggplot(test[test['method'] == 'SMH-2-NB']) +
aes(x='acc_rate', y='MSJD_over_B', colour='method') +  
    geom_line(linetype = "dashed", size=2) +
    geom_point(aes(shape = 'method'), size=6) +
    # geom_segment(aes(x = 1.5, xend = 1.5, y = 0, yend = 4e-7), colour='#1F78B4', size=0.4, linetype='dotted') +
