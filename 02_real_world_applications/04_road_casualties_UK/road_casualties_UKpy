...
# Data directory
DATA_DIR = BASE_DIR / "04_road_casualties_UK"

# Output directory
dir = DATA_DIR

# Load datasets
col_2020 = pd.read_csv(
    DATA_DIR / "dft-road-casualty-statistics-collision-2020.csv",
    low_memory=False
)

col_2021 = pd.read_csv(
    DATA_DIR / "dft-road-casualty-statistics-collision-2021.csv",
    low_memory=False
)

col_2022 = pd.read_csv(
    DATA_DIR / "dft-road-casualty-statistics-collision-2022.csv",
    low_memory=False
)
